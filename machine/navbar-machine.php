    ...
    <div class="collapse navbar-collapse" id="mynavbar">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">แจ้งซ่อมเครื่องจักร</a>
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="index-machine.php">รายการแจ้งซ่อม</a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="manage_dep_machine.php">จัดการแผนกเครื่องจักร</a></li>
                <li><a class="dropdown-item" href="manage_machine.php">จัดการรายการเครื่องจักร</a></li>
            </ul>
        </li>
        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">รายงาน</a>
            <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="#">รายงานแจ้งซ่อมเครื่องจักร</a></li>
            </ul>
        </li>
